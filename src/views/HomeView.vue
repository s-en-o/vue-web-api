        ...
        <div class="py-8 px-4 mx-auto max-w-screen-xl sm:py-16 lg:px-6">
            ...
            <div
                ...
                <div>
                    ...
                    <RouterLink
                        to="/drag-drop"
                        class="inline-flex items-center px-5 py-2.5 text-sm font-medium text-center text-white bg-blue-700 rounded-lg hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800 mt-4">
                        See example
                        <svg
                ...
                <div>
                    ...
                    <p class="text-gray-500 dark:text-gray-400">
                        Recording audio example with
                        <a
                            href="https://developer.mozilla.org/en-US/docs/Web/API/MediaRecorder"
                            target="_blank"
                            rel="noopener noreferrer"
                            class="font-medium text-blue-600 dark:text-blue-500 hover:underline"
                            >MediaRecorder from MediaStream Recording API</a
                        >.
                    </p>
